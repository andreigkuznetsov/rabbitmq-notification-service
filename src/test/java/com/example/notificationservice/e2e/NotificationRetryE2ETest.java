...
class NotificationRetryE2ETest extends BaseE2ETest {
    ...
    @Test
    void shouldReturnAcceptedAndMoveNotificationToRetryStatus() {
        ...
        Awaitility.await()
                ...
                .untilAsserted(() -> {
                    ...
                    assertThat(entity.getErrorCode()).isEqualTo("RETRYABLE_PROVIDER_ERROR");
                });
    }
}
